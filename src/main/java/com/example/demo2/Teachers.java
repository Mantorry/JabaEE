...
public class Teachers {
    ...
    public Teachers(Long id, Long idChairs, Long idPosts, String firstName, String secondName, String lastName, String phone, String email, Chairs chairs, Posts posts) {
        this.id = id;
